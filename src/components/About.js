    ...
    return (
        <div className={styles.app}>
            <div className={styles.aboutContainer}>
                <h1>About Me</h1>
                <p>
                    I am a <span style={{color: 'yellow'}}>18</span> year old, <span style={{color: 'orange'}}>JS</span> web developer, with initials that placed me in tech from day 1 (<span style={{color: 'red'}}>DNS</span>).
